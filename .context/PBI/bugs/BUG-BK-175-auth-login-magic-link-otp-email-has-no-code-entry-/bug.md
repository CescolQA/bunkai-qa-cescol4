...
**SUMMARY**
The staging magic-link login flow cannot be completed: Supabase Auth sends a 6-digit OTP code by email, but the "Check your inbox" confirmation screen renders no input field to enter that code. This blocks login entirely on staging, preventing all QA work — including [https://jira.upexgalaxy.com/browse/BK-23#icft=BK-23](https://jira.upexgalaxy.com/browse/BK-23#icft=BK-23) verification — from proceeding.

---

**STEPS TO REPRODUCE**

#### Step 1 - Precondition: no active session, navigate to [https://staging-upexbunkai.vercel.app/login](https://staging-upexbunkai.vercel.app/login)
...
- Blocks 100% of staging-dependent QA work; currently blocking [https://jira.upexgalaxy.com/browse/BK-23#icft=BK-23](https://jira.upexgalaxy.com/browse/BK-23#icft=BK-23) (Duplicate ATC) verification
...
- Related: [https://jira.upexgalaxy.com/browse/BK-23#icft=BK-23](https://jira.upexgalaxy.com/browse/BK-23#icft=BK-23)
