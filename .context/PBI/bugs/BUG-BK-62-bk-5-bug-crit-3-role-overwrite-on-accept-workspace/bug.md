...
## Evidence - [https://jira.upexgalaxy.com/browse/BK-62#icft=BK-62](https://jira.upexgalaxy.com/browse/BK-62#icft=BK-62): Role overwrite on accept upsert demotes owner

### Repro: Step 1 - invite (curl)

curl -X POST [https://staging-upexbunkai.vercel.app/api/v1/workspaces/aed86386-2ed8-424e-934b-ca7a0ef6af37/invites](https://staging-upexbunkai.vercel.app/api/v1/workspaces/aed86386-2ed8-424e-934b-ca7a0ef6af37/invites) -H 'content-type: application/json' -d '{"email":"qa-headless@bunkai.io","role":"member"}'

Response: 201, token bk*inv*2rTgTxbLC5R21dcL6WpGX

### Repro: Step 2 - accept (curl)

curl -X POST [https://staging-upexbunkai.vercel.app/api/v1/invites/accept](https://staging-upexbunkai.vercel.app/api/v1/invites/accept) -H 'content-type: application/json' -d '{"token":"bk*inv*2rTgTxbLC5R21dcL6WpGX"}'
